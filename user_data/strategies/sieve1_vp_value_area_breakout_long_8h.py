...
ENTRY_MODE = "entry_vp_value_area_breakout_long_8h"
ENTRY_TAG = "vp_value_area_breakout_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1VPValueAreaBreakoutLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_entry_trigger_long") & _num(dataframe, "vp_score_long").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_long").ge(_num(dataframe, "vp_score_short")) & _bool(dataframe, "vp_above_value_area") & _num(dataframe, "close").gt(_num(dataframe, "vp_prior_vah", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaBreakoutLong8H)
