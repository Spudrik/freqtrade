...
ENTRY_MODE = "entry_continuation_flag_present_short_1d"
ENTRY_TAG = "continuation_flag_present_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1ContinuationFlagPresentShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagPresentShort1D)
