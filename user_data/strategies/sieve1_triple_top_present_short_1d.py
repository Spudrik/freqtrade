...
ENTRY_MODE = "entry_triple_top_present_short_1d"
ENTRY_TAG = "triple_top_present_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1TripleTopPresentShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TripleTopPresentShort1D)
