...
ENTRY_MODE = "entry_triple_bottom_present_long_1d"
ENTRY_TAG = "triple_bottom_present_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1TripleBottomPresentLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TripleBottomPresentLong1D)
