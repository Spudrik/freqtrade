...
ENTRY_MODE = "entry_vp_node_entry_long"
ENTRY_TAG = "vp_node_entry_long"
SIDE = "long"
TRIGGER_COLUMN = "vp_node_entry_long"
CORE_BEHAVIOR = "VP node-only long trigger"
...
class Sieve1VpNodeEntryLong(IStrategy):
    """
    Sieve1 volume-profile entry concept: VP node-only long trigger.
...
apply_explicit_hyperopt_surface(Sieve1VpNodeEntryLong)
