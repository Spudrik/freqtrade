...
ENTRY_MODE = "entry_vp_value_area_breakdown_short"
ENTRY_TAG = "vp_value_area_breakdown_short"
SIDE = "short"
TRIGGER_COLUMN = "vp_entry_trigger_short"
CORE_BEHAVIOR = "value area breakdown with pressure"
...
class Sieve1VpValueAreaBreakdownShort(IStrategy):
    """
    Sieve1 volume-profile entry concept: value area breakdown with pressure.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            ...
            & _bool(dataframe, "vp_below_value_area")
            & _num(dataframe, "close").lt(_num(dataframe, "vp_prior_val", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VpValueAreaBreakdownShort)
