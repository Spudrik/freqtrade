...
ENTRY_MODE = "entry_vp_lvn_fast_traverse_long_1h"
ENTRY_TAG = "vp_lvn_fast_traverse_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1VPLVNFastTraverseLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLVNFastTraverseLong1H)
