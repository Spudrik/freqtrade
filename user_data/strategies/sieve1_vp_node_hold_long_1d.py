...
ENTRY_MODE = "entry_vp_node_hold_long_1d"
ENTRY_TAG = "vp_node_hold_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1VPNodeHoldLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPNodeHoldLong1D)
