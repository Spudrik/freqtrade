...
ENTRY_MODE = "entry_continuation_flag_present_short_1h"
ENTRY_TAG = "continuation_flag_present_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1ContinuationFlagPresentShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_flag_pattern_present") & _num(dataframe, "pat_flag_direction").le(-1) & _num(dataframe, "pat_flag_indicator_score").ge(float(self.score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagPresentShort1H)
