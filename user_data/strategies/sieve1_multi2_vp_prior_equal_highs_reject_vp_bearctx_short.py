...
ENTRY_MODE = "entry_multi2_vp_prior_equal_highs_reject_vp_bearctx_short"
ENTRY_TAG = "multi2_vp_prior_equal_highs_reject_vp_bearctx_short"
SIDE = "short"
TIMEFRAME = "1h"
VP_CONFIRM = "bear_context"
PRIOR_KIND = "equal_highs_reject"

class Sieve1Multi2VpPriorEqualHighsRejectVpBearctxShort(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorEqualHighsRejectVpBearctxShort)
