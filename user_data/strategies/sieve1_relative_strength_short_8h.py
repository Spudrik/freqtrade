...
ENTRY_MODE = "entry_relative_strength_short_8h"
ENTRY_TAG = "relative_strength_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1RelativeStrengthShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthShort8H)
