...
ENTRY_MODE = "entry_multi2_tlv2_vp_res_break_vp_bullctx_long_8h"
ENTRY_TAG = "multi2_tlv2_vp_res_break_vp_bullctx_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1Multi2Tlv2VpResBreakVpBullctxLong8h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2VpResBreakVpBullctxLong8h)
