...
ENTRY_MODE = "entry_continuation_pennant_confirmed_long_8h"
ENTRY_TAG = "continuation_pennant_confirmed_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1ContinuationPennantConfirmedLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        _ = metadata
        dataframe = add_pattern_continuation(dataframe, timeframe=self.timeframe, min_pennant_quality=float(self.score_min.value))
        return dataframe
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_pennant_pattern_confirmed") & _num(dataframe, "pat_pennant_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").ge(_num(dataframe, "pat_pennant_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationPennantConfirmedLong8H)
