...
ENTRY_MODE = "entry_reversal_head_shoulders_present_short_1h"
ENTRY_TAG = "reversal_head_shoulders_present_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1ReversalHeadShouldersPresentShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        level = _num(dataframe, "pat_head_shoulders_confirmation_level", np.nan).mul(1.0 - float(self.confirmation_buffer_pct.value))
        condition = _bool(dataframe, "pat_head_shoulders_pattern_present") & _num(dataframe, "pat_head_shoulders_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").lt(level)
...
apply_explicit_hyperopt_surface(Sieve1ReversalHeadShouldersPresentShort1H)
