...
ENTRY_MODE = "entry_geometry_triangle_lower_reclaim_long_1d"
ENTRY_TAG = "geometry_triangle_lower_reclaim_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1GeometryTriangleLowerReclaimLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryTriangleLowerReclaimLong1D)
