...
ENTRY_MODE = "entry_vp_value_area_breakout_long_1d"
ENTRY_TAG = "vp_value_area_breakout_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1VPValueAreaBreakoutLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaBreakoutLong1D)
