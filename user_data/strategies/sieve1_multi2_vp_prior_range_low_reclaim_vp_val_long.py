...
ENTRY_MODE = "entry_multi2_vp_prior_range_low_reclaim_vp_val_long"
ENTRY_TAG = "multi2_vp_prior_range_low_reclaim_vp_val_long"
SIDE = "long"
TIMEFRAME = "1h"
VP_CONFIRM = "val_reclaim"
PRIOR_KIND = "range_low_reclaim"

class Sieve1Multi2VpPriorRangeLowReclaimVpValLong(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorRangeLowReclaimVpValLong)
