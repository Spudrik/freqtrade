...
ENTRY_MODE = "entry_reversal_double_top_confirmed_short_1h"
ENTRY_TAG = "reversal_double_top_confirmed_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1ReversalDoubleTopConfirmedShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ReversalDoubleTopConfirmedShort1H)
