...
ENTRY_MODE = "entry_bos_bull_continuation_long_1h"
ENTRY_TAG = "bos_bull_continuation_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1BOSBullContinuationLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1BOSBullContinuationLong1H)
