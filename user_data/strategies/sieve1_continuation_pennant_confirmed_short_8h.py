...
ENTRY_MODE = "entry_continuation_pennant_confirmed_short_8h"
ENTRY_TAG = "continuation_pennant_confirmed_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1ContinuationPennantConfirmedShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        _ = metadata
        dataframe = add_pattern_continuation(dataframe, timeframe=self.timeframe, min_flag_quality=float(self.score_min.value))
        return dataframe
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_pennant_pattern_confirmed") & _num(dataframe, "pat_pennant_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").le(_num(dataframe, "pat_pennant_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationPennantConfirmedShort8H)
