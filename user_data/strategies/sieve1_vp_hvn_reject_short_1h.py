...
ENTRY_MODE = "entry_vp_hvn_reject_short_1h"
ENTRY_TAG = "vp_hvn_reject_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPHVNRejectShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPHVNRejectShort1H)
