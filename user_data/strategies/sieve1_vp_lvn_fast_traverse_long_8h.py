...
ENTRY_MODE = "entry_vp_lvn_fast_traverse_long_8h"
ENTRY_TAG = "vp_lvn_fast_traverse_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1VPLVNFastTraverseLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLVNFastTraverseLong8H)
