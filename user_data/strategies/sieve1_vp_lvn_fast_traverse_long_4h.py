...
ENTRY_MODE = "entry_vp_lvn_fast_traverse_long_4h"
ENTRY_TAG = "vp_lvn_fast_traverse_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1VPLVNFastTraverseLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLVNFastTraverseLong4H)
