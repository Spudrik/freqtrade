...
ENTRY_MODE = "entry_continuation_flag_setup_long_1h"
ENTRY_TAG = "continuation_flag_setup_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1ContinuationFlagSetupLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagSetupLong1H)
