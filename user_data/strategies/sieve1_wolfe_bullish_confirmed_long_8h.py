...
ENTRY_MODE = "entry_wolfe_bullish_confirmed_long_8h"
ENTRY_TAG = "wolfe_bullish_confirmed_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1WolfeBullishConfirmedLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pww_bullish_pattern_confirmed") & _num(dataframe, "pww_bullish_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").ge(_num(dataframe, "pww_bullish_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1WolfeBullishConfirmedLong8H)
