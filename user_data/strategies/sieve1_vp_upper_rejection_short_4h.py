...
ENTRY_MODE = "entry_vp_upper_rejection_short_4h"
ENTRY_TAG = "vp_upper_rejection_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1VPUpperRejectionShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_upper_rejection_with_pressure") & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1VPUpperRejectionShort4H)
