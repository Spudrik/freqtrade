...
ENTRY_MODE = "entry_relative_strength_bear_context_short_8h"
ENTRY_TAG = "relative_strength_bear_context_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1RelativeStrengthBearContextShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthBearContextShort8H)
