...
ENTRY_MODE = "entry_triple_top_present_short_8h"
ENTRY_TAG = "triple_top_present_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1TripleTopPresentShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_triple_top_pattern_present") & _num(dataframe, "pat_triple_top_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").le(_num(dataframe, "pat_triple_top_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1TripleTopPresentShort8H)
