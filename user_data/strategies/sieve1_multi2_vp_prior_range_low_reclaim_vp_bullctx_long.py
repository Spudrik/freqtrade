...
ENTRY_MODE = "entry_multi2_vp_prior_range_low_reclaim_vp_bullctx_long"
ENTRY_TAG = "multi2_vp_prior_range_low_reclaim_vp_bullctx_long"
SIDE = "long"
TIMEFRAME = "1h"
VP_CONFIRM = "bull_context"
PRIOR_KIND = "range_low_reclaim"

class Sieve1Multi2VpPriorRangeLowReclaimVpBullctxLong(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorRangeLowReclaimVpBullctxLong)
