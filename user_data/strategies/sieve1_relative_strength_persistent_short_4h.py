...
ENTRY_MODE = "entry_relative_strength_persistent_short_4h"
ENTRY_TAG = "relative_strength_persistent_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1RelativeStrengthPersistentShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "rs_persistent_weakness") & _num(dataframe, "rs_score_short").ge(float(self.entry_score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthPersistentShort4H)
