...
ENTRY_MODE = "entry_geometry_wedge_lower_reclaim_long_1d"
ENTRY_TAG = "geometry_wedge_lower_reclaim_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1GeometryWedgeLowerReclaimLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryWedgeLowerReclaimLong1D)
