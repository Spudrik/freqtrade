...
ENTRY_MODE = "entry_vp_value_area_reentry_long_1h"
ENTRY_TAG = "vp_value_area_reentry_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1VPValueAreaReentryLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_in_value_area") & _num(dataframe, "close").gt(val) & _num(dataframe, "close").shift(1).lt(val.shift(1)) & _num(dataframe, "vp_score_long").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_long").ge(_num(dataframe, "vp_score_short"))
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaReentryLong1H)
