...
ENTRY_MODE = "entry_multi4_prior_range_avwap_vp_breakdown_short"
ENTRY_TAG = "multi4_prior_range_avwap_vp_breakdown_short"
SIDE = "short"
CONCEPT = "multi4_prior_range_avwap_vp_breakdown"
PERIOD_KIND = "select"
...
class Sieve1Multi4PriorRangeAvwapVpBreakdownShort(IStrategy):
    """
    Sieve1 entry concept: multi4_prior_range_avwap_vp_breakdown_short.
    ...
    rolling_level_lookback = tagged_parameter(CategoricalParameter([48, 72, 120, 168], default=72, space="buy", optimize=True, load=True))
...
apply_explicit_hyperopt_surface(Sieve1Multi4PriorRangeAvwapVpBreakdownShort)
