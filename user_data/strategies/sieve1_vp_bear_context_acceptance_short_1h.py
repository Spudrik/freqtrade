...
ENTRY_MODE = "entry_vp_bear_context_acceptance_short_1h"
ENTRY_TAG = "vp_bear_context_acceptance_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPBearContextAcceptanceShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPBearContextAcceptanceShort1H)
