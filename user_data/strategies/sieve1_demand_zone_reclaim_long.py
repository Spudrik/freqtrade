...
ENTRY_MODE = "entry_demand_zone_reclaim_long"
ENTRY_TAG = "demand_zone_reclaim_long"
SIDE = "long"
CONCEPT = "demand_reclaim"
PERIOD_KIND = "fixed"
...
class Sieve1DemandZoneReclaimLong(IStrategy):
    """
    Sieve1 entry concept: demand_zone_reclaim_long.
...
apply_explicit_hyperopt_surface(Sieve1DemandZoneReclaimLong)
