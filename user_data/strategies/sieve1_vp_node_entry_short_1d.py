...
ENTRY_MODE = "entry_vp_node_entry_short_1d"
ENTRY_TAG = "vp_node_entry_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1VPNodeEntryShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_node_entry_short") & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1VPNodeEntryShort1D)
