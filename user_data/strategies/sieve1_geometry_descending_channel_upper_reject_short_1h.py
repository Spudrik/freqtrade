...
ENTRY_MODE = "entry_geometry_descending_channel_upper_reject_short_1h"
ENTRY_TAG = "geometry_descending_channel_upper_reject_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1GeometryDescendingChannelUpperRejectShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        upper = _num(dataframe, "pg2_descending_channel_upper", np.nan)
        condition = _bool(dataframe, "pg2_descending_channel_pattern_present") & _num(dataframe, "pg2_descending_channel_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "pg2_descending_channel_width_atr", np.nan).le(float(self.width_atr_max.value)) & _num(dataframe, "high").ge(upper.mul(1.0 - float(self.rail_buffer_pct.value))) & _num(dataframe, "close").lt(upper) & _num(dataframe, "close").lt(_num(dataframe, "open"))
...
apply_explicit_hyperopt_surface(Sieve1GeometryDescendingChannelUpperRejectShort1H)
