...
ENTRY_MODE = "entry_avwap_reclaim_long"
ENTRY_TAG = "avwap_reclaim_long"
SIDE = "long"
CONCEPT = "avwap_reclaim"
PERIOD_KIND = "fixed"
...
class Sieve1AvwapReclaimLong(IStrategy):
    """
    Sieve1 entry concept: avwap_reclaim_long.
...
apply_explicit_hyperopt_surface(Sieve1AvwapReclaimLong)
