...
ENTRY_MODE = "entry_geometry_compression_breakdown_short_4h"
ENTRY_TAG = "geometry_compression_breakdown_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1GeometryCompressionBreakdownShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pg2_compression_pattern_present") & _bool(dataframe, "pg2_compression_squeeze_active") & _num(dataframe, "pg2_compression_indicator_score").ge(float(self.min_line_score.value)) & _num(dataframe, "pg2_compression_direction").le(0) & _num(dataframe, "close").lt(_num(dataframe, "pg2_compression_lower", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1GeometryCompressionBreakdownShort4H)
