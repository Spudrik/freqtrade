...
ENTRY_MODE = "entry_triple_top_present_short_4h"
ENTRY_TAG = "triple_top_present_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1TripleTopPresentShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TripleTopPresentShort4H)
