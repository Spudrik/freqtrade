...
ENTRY_MODE = "entry_vp_value_area_reentry_long_4h"
ENTRY_TAG = "vp_value_area_reentry_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1VPValueAreaReentryLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaReentryLong4H)
