...
ENTRY_MODE = "entry_triple_top_confirmed_short_8h"
ENTRY_TAG = "triple_top_confirmed_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1TripleTopConfirmedShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TripleTopConfirmedShort8H)
