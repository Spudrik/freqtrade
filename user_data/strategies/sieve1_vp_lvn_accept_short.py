...
ENTRY_MODE = "entry_vp_lvn_accept_short"
ENTRY_TAG = "vp_lvn_accept_short"
SIDE = "short"
TRIGGER_COLUMN = "vp_node_entry_short"
CORE_BEHAVIOR = "LVN downside acceptance"
...
class Sieve1VpLvnAcceptShort(IStrategy):
    """
    Sieve1 volume-profile entry concept: LVN downside acceptance.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            ...
            & _num(dataframe, "close").lt(_num(dataframe, "vp_lvn_above", np.nan))
            & (_bool(dataframe, "vp_in_value_area") | _bool(dataframe, "vp_below_value_area") | _num(dataframe, "vp_market_context").le(0))
...
apply_explicit_hyperopt_surface(Sieve1VpLvnAcceptShort)
