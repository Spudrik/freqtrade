...
ENTRY_MODE = "entry_vp_hvn_reclaim_long_1d"
ENTRY_TAG = "vp_hvn_reclaim_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1VPHVNReclaimLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPHVNReclaimLong1D)
