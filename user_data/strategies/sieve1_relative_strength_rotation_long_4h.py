...
ENTRY_MODE = "entry_relative_strength_rotation_long_4h"
ENTRY_TAG = "relative_strength_rotation_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1RelativeStrengthRotationLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "rs_entry_rotation_long") & _num(dataframe, "rs_score_long").ge(float(self.entry_score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthRotationLong4H)
