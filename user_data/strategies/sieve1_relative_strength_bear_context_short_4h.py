...
ENTRY_MODE = "entry_relative_strength_bear_context_short_4h"
ENTRY_TAG = "relative_strength_bear_context_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1RelativeStrengthBearContextShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "rs_market_context").le(-int(self.context_gate.value)) & _num(dataframe, "rs_score_short").gt(_num(dataframe, "rs_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthBearContextShort4H)
