...
ENTRY_MODE = "entry_geometry_triangle_squeeze_breakout_long_1d"
ENTRY_TAG = "geometry_triangle_squeeze_breakout_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1GeometryTriangleSqueezeBreakoutLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pg2_triangle_pattern_present") & _bool(dataframe, "pg2_triangle_squeeze_active") & _num(dataframe, "pg2_triangle_indicator_score").ge(float(self.min_line_score.value)) & _num(dataframe, "pg2_triangle_direction").ge(0) & _num(dataframe, "close").gt(_num(dataframe, "pg2_triangle_upper", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1GeometryTriangleSqueezeBreakoutLong1D)
