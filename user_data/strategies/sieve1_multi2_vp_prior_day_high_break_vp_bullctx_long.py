...
ENTRY_MODE = "entry_multi2_vp_prior_day_high_break_vp_bullctx_long"
ENTRY_TAG = "multi2_vp_prior_day_high_break_vp_bullctx_long"
SIDE = "long"
TIMEFRAME = "1h"
VP_CONFIRM = "bull_context"
PRIOR_KIND = "day_high_breakout"

class Sieve1Multi2VpPriorDayHighBreakVpBullctxLong(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorDayHighBreakVpBullctxLong)
