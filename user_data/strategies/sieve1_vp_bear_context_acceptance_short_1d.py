...
ENTRY_MODE = "entry_vp_bear_context_acceptance_short_1d"
ENTRY_TAG = "vp_bear_context_acceptance_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1VPBearContextAcceptanceShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPBearContextAcceptanceShort1D)
