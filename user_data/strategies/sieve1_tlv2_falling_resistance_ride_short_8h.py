...
ENTRY_MODE = "entry_tlv2_falling_resistance_ride_short_8h"
ENTRY_TAG = "tlv2_falling_resistance_ride_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1TLV2FallingResistanceRideShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "tlv2_resistance_score_rank0").ge(float(self.score_min.value)) & _num(dataframe, "tlv2_resistance_distance_atr_rank0", np.nan).le(float(self.distance_atr_max.value)) & line.pct_change(fill_method=None).lt(-float(self.line_slope_min_pct.value)) & _num(dataframe, "close").lt(line)
...
apply_explicit_hyperopt_surface(Sieve1TLV2FallingResistanceRideShort8H)
