...
ENTRY_MODE = "entry_reversal_double_top_present_short_4h"
ENTRY_TAG = "reversal_double_top_present_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1ReversalDoubleTopPresentShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ReversalDoubleTopPresentShort4H)
