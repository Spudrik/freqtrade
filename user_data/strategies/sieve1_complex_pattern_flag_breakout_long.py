...
ENTRY_TAG = "complex_pattern_break_long"
SIDE = "long"
...
class Sieve1ComplexPatternFlagBreakoutLong(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            pattern_ready
            & (dataframe["close"] > dataframe["recent_high"] * (1.0 + buffer))
...
apply_explicit_hyperopt_surface(Sieve1ComplexPatternFlagBreakoutLong)
