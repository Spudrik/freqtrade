...
class Sieve1Multi3PriorAvwapVpBreakoutLong(IStrategy):
    """
    Sieve1 entry concept: multi3_prior_avwap_vp_breakout_long.
...
apply_explicit_hyperopt_surface(Sieve1Multi3PriorAvwapVpBreakoutLong)
