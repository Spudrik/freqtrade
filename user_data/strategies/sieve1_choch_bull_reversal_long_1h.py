...
ENTRY_MODE = "entry_choch_bull_reversal_long_1h"
ENTRY_TAG = "choch_bull_reversal_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1ChochBullReversalLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ChochBullReversalLong1H)
