...
ENTRY_MODE = "entry_vp_lvn_accept_long"
ENTRY_TAG = "vp_lvn_accept_long"
SIDE = "long"
TRIGGER_COLUMN = "vp_node_entry_long"
CORE_BEHAVIOR = "LVN upside acceptance"
...
class Sieve1VpLvnAcceptLong(IStrategy):
    """
    Sieve1 volume-profile entry concept: LVN upside acceptance.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            ...
            & _num(dataframe, "close").gt(_num(dataframe, "vp_lvn_below", np.nan))
            & (_bool(dataframe, "vp_in_value_area") | _bool(dataframe, "vp_above_value_area") | _num(dataframe, "vp_market_context").ge(0))
...
apply_explicit_hyperopt_surface(Sieve1VpLvnAcceptLong)
