...
ENTRY_MODE = "entry_vp_upper_rejection_short_1h"
ENTRY_TAG = "vp_upper_rejection_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPUpperRejectionShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPUpperRejectionShort1H)
