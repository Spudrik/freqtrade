...
ENTRY_MODE = "entry_relative_strength_long_1d"
ENTRY_TAG = "relative_strength_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1RelativeStrengthLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthLong1D)
