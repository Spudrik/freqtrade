...
ENTRY_MODE = "entry_relative_strength_long_8h"
ENTRY_TAG = "relative_strength_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1RelativeStrengthLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthLong8H)
