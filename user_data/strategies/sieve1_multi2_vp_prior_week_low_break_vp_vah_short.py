...
ENTRY_MODE = "entry_multi2_vp_prior_week_low_break_vp_vah_short"
ENTRY_TAG = "multi2_vp_prior_week_low_break_vp_vah_short"
SIDE = "short"
TIMEFRAME = "1h"
VP_CONFIRM = "vah_reject"
PRIOR_KIND = "week_low_breakdown"

class Sieve1Multi2VpPriorWeekLowBreakVpVahShort(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorWeekLowBreakVpVahShort)
