...
ENTRY_MODE = "entry_multi2_vp_prior_equal_lows_reclaim_vp_bullctx_long"
ENTRY_TAG = "multi2_vp_prior_equal_lows_reclaim_vp_bullctx_long"
SIDE = "long"
TIMEFRAME = "1h"
VP_CONFIRM = "bull_context"
PRIOR_KIND = "equal_lows_reclaim"

class Sieve1Multi2VpPriorEqualLowsReclaimVpBullctxLong(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorEqualLowsReclaimVpBullctxLong)
