...
ENTRY_MODE = "entry_vp_poc_reject_short_8h"
ENTRY_TAG = "vp_poc_reject_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPPOCRejectShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _cross_below(_num(dataframe, "close"), poc) & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1VPPOCRejectShort8H)
