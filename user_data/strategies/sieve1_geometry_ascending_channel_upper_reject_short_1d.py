...
ENTRY_MODE = "entry_geometry_ascending_channel_upper_reject_short_1d"
ENTRY_TAG = "geometry_ascending_channel_upper_reject_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1GeometryAscendingChannelUpperRejectShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryAscendingChannelUpperRejectShort1D)
