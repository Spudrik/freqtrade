...
ENTRY_MODE = "entry_vp_vah_reject_short_1h"
ENTRY_TAG = "vp_vah_reject_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPVAHRejectShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "high").gt(vah) & _num(dataframe, "close").lt(vah) & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1VPVAHRejectShort1H)
