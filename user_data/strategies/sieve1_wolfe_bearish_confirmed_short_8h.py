...
ENTRY_MODE = "entry_wolfe_bearish_confirmed_short_8h"
ENTRY_TAG = "wolfe_bearish_confirmed_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1WolfeBearishConfirmedShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pww_bearish_pattern_confirmed") & _num(dataframe, "pww_bearish_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").le(_num(dataframe, "pww_bearish_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1WolfeBearishConfirmedShort8H)
