...
ENTRY_MODE = "entry_vp_node_entry_long_8h"
ENTRY_TAG = "vp_node_entry_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1VPNodeEntryLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_node_entry_long") & _num(dataframe, "vp_score_long").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_long").ge(_num(dataframe, "vp_score_short"))
...
apply_explicit_hyperopt_surface(Sieve1VPNodeEntryLong8H)
