...
ENTRY_MODE = "entry_geometry_triangle_upper_reject_short_1h"
ENTRY_TAG = "geometry_triangle_upper_reject_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1GeometryTriangleUpperRejectShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryTriangleUpperRejectShort1H)
