...
ENTRY_MODE = "entry_vp_hvn_reclaim_long_4h"
ENTRY_TAG = "vp_hvn_reclaim_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1VPHVNReclaimLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_hvn_below_reclaim") & _num(dataframe, "vp_score_long").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_long").ge(_num(dataframe, "vp_score_short"))
...
apply_explicit_hyperopt_surface(Sieve1VPHVNReclaimLong4H)
