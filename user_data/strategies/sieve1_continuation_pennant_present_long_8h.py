...
ENTRY_MODE = "entry_continuation_pennant_present_long_8h"
ENTRY_TAG = "continuation_pennant_present_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1ContinuationPennantPresentLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_pennant_pattern_present") & _num(dataframe, "pat_pennant_direction").ge(1) & _num(dataframe, "pat_pennant_indicator_score").ge(float(self.score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationPennantPresentLong8H)
