...
ENTRY_MODE = "entry_vp_lvn_fast_traverse_short_8h"
ENTRY_TAG = "vp_lvn_fast_traverse_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPLVNFastTraverseShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_lvn_fast_traverse_short") & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1VPLVNFastTraverseShort8H)
