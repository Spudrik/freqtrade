...
ENTRY_MODE = "entry_bos_bull_continuation_long_4h"
ENTRY_TAG = "bos_bull_continuation_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1BOSBullContinuationLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1BOSBullContinuationLong4H)
