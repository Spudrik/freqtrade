...
ENTRY_MODE = "entry_vp_entry_trigger_short_1h"
ENTRY_TAG = "vp_entry_trigger_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPEntryTriggerShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_entry_trigger_short") & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1VPEntryTriggerShort1H)
