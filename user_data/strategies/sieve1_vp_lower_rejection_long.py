...
ENTRY_MODE = "entry_vp_lower_rejection_long"
ENTRY_TAG = "vp_lower_rejection_long"
SIDE = "long"
TRIGGER_COLUMN = "vp_entry_trigger_long"
CORE_BEHAVIOR = "failed downside auction back into value"
...
class Sieve1VpLowerRejectionLong(IStrategy):
    """
    Sieve1 volume-profile entry concept: failed downside auction back into value.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            ...
            & _num(dataframe, "low").le(_num(dataframe, "vp_prior_val", np.nan))
            & _num(dataframe, "close").gt(_num(dataframe, "vp_prior_val", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VpLowerRejectionLong)
