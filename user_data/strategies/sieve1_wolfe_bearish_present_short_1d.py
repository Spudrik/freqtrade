...
ENTRY_MODE = "entry_wolfe_bearish_present_short_1d"
ENTRY_TAG = "wolfe_bearish_present_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1WolfeBearishPresentShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1WolfeBearishPresentShort1D)
