...
ENTRY_MODE = "entry_complex_resistance_breakout_long"
ENTRY_TAG = "codex_complex_res_break_long"
SIDE = "long"
CORE_BEHAVIOR = "resistance breakout acceptance"
...
class CodexComplexResistanceBreakoutLong(IStrategy):
    """
    Break above recent/pivot resistance with structure, volatility expansion, and volume acceptance.

    Single-entry Entry Sieve research strategy.
    Objective: test whether resistance breakout acceptance has standalone edge under fixed +2%/-2% exits.
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            (dataframe["close"] > dataframe["codex_resistance_ref"] * (1.0 + buffer))
            ...
            & (_bool(dataframe, "vol_vol_breakout_confirm_long") | _bool(dataframe, "vp_vah_breakout_with_pressure"))
        )
...
apply_explicit_hyperopt_surface(CodexComplexResistanceBreakoutLong)
