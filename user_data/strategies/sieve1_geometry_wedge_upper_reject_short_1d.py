...
ENTRY_MODE = "entry_geometry_wedge_upper_reject_short_1d"
ENTRY_TAG = "geometry_wedge_upper_reject_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1GeometryWedgeUpperRejectShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryWedgeUpperRejectShort1D)
