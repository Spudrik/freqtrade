...
ENTRY_MODE = "entry_geometry_descending_channel_upper_reject_short_8h"
ENTRY_TAG = "geometry_descending_channel_upper_reject_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1GeometryDescendingChannelUpperRejectShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryDescendingChannelUpperRejectShort8H)
