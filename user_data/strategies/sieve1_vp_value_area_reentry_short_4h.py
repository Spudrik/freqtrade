...
ENTRY_MODE = "entry_vp_value_area_reentry_short_4h"
ENTRY_TAG = "vp_value_area_reentry_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1VPValueAreaReentryShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaReentryShort4H)
