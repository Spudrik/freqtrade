...
ENTRY_MODE = "entry_multi2_vp_prior_equal_highs_reject_vp_node_short"
ENTRY_TAG = "multi2_vp_prior_equal_highs_reject_vp_node_short"
SIDE = "short"
TIMEFRAME = "1h"
VP_CONFIRM = "node_entry"
PRIOR_KIND = "equal_highs_reject"

class Sieve1Multi2VpPriorEqualHighsRejectVpNodeShort(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorEqualHighsRejectVpNodeShort)
