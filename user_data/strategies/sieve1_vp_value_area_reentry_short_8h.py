...
ENTRY_MODE = "entry_vp_value_area_reentry_short_8h"
ENTRY_TAG = "vp_value_area_reentry_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPValueAreaReentryShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "vp_in_value_area") & _num(dataframe, "close").lt(vah) & _num(dataframe, "close").shift(1).gt(vah.shift(1)) & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long"))
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaReentryShort8H)
