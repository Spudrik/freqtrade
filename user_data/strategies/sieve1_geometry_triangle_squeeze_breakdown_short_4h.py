...
ENTRY_MODE = "entry_geometry_triangle_squeeze_breakdown_short_4h"
...
class Sieve1GeometryTriangleSqueezeBreakdownShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryTriangleSqueezeBreakdownShort4H)
