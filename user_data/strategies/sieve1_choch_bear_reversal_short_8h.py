...
ENTRY_MODE = "entry_choch_bear_reversal_short_8h"
ENTRY_TAG = "choch_bear_reversal_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1ChochBearReversalShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ChochBearReversalShort8H)
