...
ENTRY_MODE = "entry_vp_bull_context_acceptance_long_1h"
ENTRY_TAG = "vp_bull_context_acceptance_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1VPBullContextAcceptanceLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPBullContextAcceptanceLong1H)
