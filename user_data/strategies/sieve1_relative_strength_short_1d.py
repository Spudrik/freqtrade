...
ENTRY_MODE = "entry_relative_strength_short_1d"
ENTRY_TAG = "relative_strength_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1RelativeStrengthShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthShort1D)
