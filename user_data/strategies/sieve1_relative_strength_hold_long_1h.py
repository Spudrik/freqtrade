...
ENTRY_MODE = "entry_relative_strength_hold_long_1h"
ENTRY_TAG = "relative_strength_hold_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1RelativeStrengthHoldLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "rs_hold_long") & _num(dataframe, "rs_score_long").ge(float(self.entry_score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthHoldLong1H)
