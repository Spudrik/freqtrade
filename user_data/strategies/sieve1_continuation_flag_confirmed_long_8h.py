...
ENTRY_MODE = "entry_continuation_flag_confirmed_long_8h"
ENTRY_TAG = "continuation_flag_confirmed_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1ContinuationFlagConfirmedLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagConfirmedLong8H)
