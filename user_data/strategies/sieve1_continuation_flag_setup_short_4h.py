...
ENTRY_MODE = "entry_continuation_flag_setup_short_4h"
ENTRY_TAG = "continuation_flag_setup_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1ContinuationFlagSetupShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagSetupShort4H)
