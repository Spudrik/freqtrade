...
ENTRY_MODE = "entry_vp_node_entry_short_8h"
ENTRY_TAG = "vp_node_entry_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPNodeEntryShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPNodeEntryShort8H)
