...
ENTRY_MODE = "entry_multi2_prior_vp_breakdown_short"
ENTRY_TAG = "multi2_prior_vp_breakdown_short"
SIDE = "short"
CONCEPT = "multi2_prior_vp_breakdown"
PERIOD_KIND = "select"
...
class Sieve1Multi2PriorVpBreakdownShort(IStrategy):
    """
    Sieve1 entry concept: multi2_prior_vp_breakdown_short.
    ...
    reclaim_buffer_pct = tagged_parameter(DecimalParameter(0.000, 0.035, decimals=3, default=0.006, space="buy", optimize=False, load=True))
...
apply_explicit_hyperopt_surface(Sieve1Multi2PriorVpBreakdownShort)
