...
ENTRY_MODE = "entry_tlv2_support_breakdown_short_8h"
ENTRY_TAG = "tlv2_support_breakdown_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1TLV2SupportBreakdownShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        line = _num(dataframe, "tlv2_support_line_rank0", np.nan).mul(1.0 - float(self.line_buffer_pct.value))
        condition = _num(dataframe, "tlv2_support_score_rank0").ge(float(self.score_min.value)) & _cross_below(_num(dataframe, "close"), line)
...
apply_explicit_hyperopt_surface(Sieve1TLV2SupportBreakdownShort8H)
