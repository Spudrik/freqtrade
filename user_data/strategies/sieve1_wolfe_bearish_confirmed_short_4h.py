...
ENTRY_MODE = "entry_wolfe_bearish_confirmed_short_4h"
ENTRY_TAG = "wolfe_bearish_confirmed_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1WolfeBearishConfirmedShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1WolfeBearishConfirmedShort4H)
