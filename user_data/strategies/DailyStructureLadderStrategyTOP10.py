...
def tagged_parameter(param: Any, *tags: str) -> Any:
    ...
    mode_alias = {
        "short_res_reclaim": "entry_core",
        "short_sup_retest_reject": "entry_core",
    }
...
class DailyStructureLadderStrategyTOP10(IStrategy):
    """
    ...
    enable_entry_family_exit_profiles = tagged_parameter(
        BooleanParameter(default=False, space="sell", optimize=True, load=True),
        "family:entry_family_exit",
        "family:feature_enables",
        "batch:entry_family_exits",
        "switch:enable",
        "domain:exit",
        "domain:price_action",
        "role:gate_toggle",
    )
    continuation_exit_profile = tagged_parameter(
        CategoricalParameter(["balanced", "runner"], default="balanced", space="sell", optimize=True, load=True),
        "family:entry_family_exit",
        "batch:entry_family_exits",
        "domain:exit",
        "role:continuation_profile",
    )
    reversal_exit_profile = tagged_parameter(
        CategoricalParameter(["balanced", "target_clip"], default="balanced", space="sell", optimize=True, load=True),
        "family:entry_family_exit",
        "batch:entry_family_exits",
        "domain:exit",
        "role:reversal_profile",
    )
    ...
    targeted_d1_exit_buffer_pct = tagged_parameter(
        DecimalParameter(0.002, 0.020, decimals=3, default=0.006, space="sell", optimize=True, load=True),
        "family:exit_target",
        "batch:targeted_d1_exits",
        "domain:exit",
        "domain:price_action",
    ...
    targeted_d1_trail_buffer_pct = tagged_parameter(
        DecimalParameter(0.002, 0.020, decimals=3, default=0.008, space="sell", optimize=True, load=True),
        "family:exit_target",
        "batch:targeted_d1_exits",
        "domain:risk",
        "action:stoploss_exit",
    ...
    enable_portfolio_risk_overlay = tagged_parameter(
        BooleanParameter(default=False, space="buy", optimize=True, load=True),
        "family:capital",
        "family:feature_enables",
        "batch:portfolio_risk_overlay",
        "switch:enable",
        "domain:capital",
        "domain:risk",
        "role:master_toggle",
    )
    portfolio_max_gross_exposure_pct = tagged_parameter(
        CategoricalParameter([150, 200, 250], default=200, space="buy", optimize=True, load=True),
        "family:capital",
        "batch:portfolio_risk_overlay",
        "domain:capital",
        "domain:risk",
        "role:gross_exposure_cap_pct",
    )
    portfolio_drawdown_entry_block_pct = tagged_parameter(
        CategoricalParameter([12, 16, 20], default=16, space="buy", optimize=True, load=True),
        "family:capital",
        "batch:portfolio_risk_overlay",
        "domain:risk",
        "role:drawdown_entry_block_pct",
    )
    portfolio_disable_adds_on_risk = tagged_parameter(
        BooleanParameter(default=True, space="buy", optimize=True, load=True),
        "family:capital",
        "family:feature_enables",
        "batch:portfolio_risk_overlay",
...
apply_explicit_hyperopt_surface(DailyStructureLadderStrategyTOP10)
