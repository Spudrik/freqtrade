...
ENTRY_MODE = "entry_vp_hvn_reclaim_long_1h"
ENTRY_TAG = "vp_hvn_reclaim_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1VPHVNReclaimLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPHVNReclaimLong1H)
