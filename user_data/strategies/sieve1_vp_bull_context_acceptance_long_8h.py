...
ENTRY_MODE = "entry_vp_bull_context_acceptance_long_8h"
ENTRY_TAG = "vp_bull_context_acceptance_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1VPBullContextAcceptanceLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPBullContextAcceptanceLong8H)
