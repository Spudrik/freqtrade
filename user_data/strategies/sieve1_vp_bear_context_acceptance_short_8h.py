...
ENTRY_MODE = "entry_vp_bear_context_acceptance_short_8h"
ENTRY_TAG = "vp_bear_context_acceptance_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPBearContextAcceptanceShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPBearContextAcceptanceShort8H)
