...
ENTRY_MODE = "entry_vp_value_area_breakdown_short_4h"
ENTRY_TAG = "vp_value_area_breakdown_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1VPValueAreaBreakdownShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaBreakdownShort4H)
