...
ENTRY_MODE = "entry_equal_lows_sweep_reclaim_long"
ENTRY_TAG = "equal_lows_sweep_reclaim_long"
SIDE = "long"
CONCEPT = "equal_lows_sweep_reclaim"
PERIOD_KIND = "fixed"
...
class Sieve1EqualLowsSweepReclaimLong(IStrategy):
    """
    Sieve1 entry concept: equal_lows_sweep_reclaim_long.
...
apply_explicit_hyperopt_surface(Sieve1EqualLowsSweepReclaimLong)
