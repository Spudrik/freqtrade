...
ENTRY_MODE = "entry_vp_lower_rejection_long_1d"
ENTRY_TAG = "vp_lower_rejection_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1VPLowerRejectionLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLowerRejectionLong1D)
