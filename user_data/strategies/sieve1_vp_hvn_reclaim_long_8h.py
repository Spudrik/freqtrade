...
ENTRY_MODE = "entry_vp_hvn_reclaim_long_8h"
ENTRY_TAG = "vp_hvn_reclaim_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1VPHVNReclaimLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPHVNReclaimLong8H)
