...
ENTRY_MODE = "entry_wolfe_bearish_present_short_1h"
ENTRY_TAG = "wolfe_bearish_present_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1WolfeBearishPresentShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pww_bearish_pattern_present") & _num(dataframe, "pww_bearish_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").le(_num(dataframe, "pww_bearish_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1WolfeBearishPresentShort1H)
