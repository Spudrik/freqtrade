...
ENTRY_MODE = "entry_vp_upper_rejection_short"
ENTRY_TAG = "vp_upper_rejection_short"
SIDE = "short"
TRIGGER_COLUMN = "vp_entry_trigger_short"
CORE_BEHAVIOR = "failed upside auction back into value"
...
class Sieve1VpUpperRejectionShort(IStrategy):
    """
    Sieve1 volume-profile entry concept: failed upside auction back into value.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            ...
            & _num(dataframe, "high").ge(_num(dataframe, "vp_prior_vah", np.nan))
            & _num(dataframe, "close").lt(_num(dataframe, "vp_prior_vah", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VpUpperRejectionShort)
