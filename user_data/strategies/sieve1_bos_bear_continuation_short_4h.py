...
ENTRY_MODE = "entry_bos_bear_continuation_short_4h"
ENTRY_TAG = "bos_bear_continuation_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1BOSBearContinuationShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1BOSBearContinuationShort4H)
