...
ENTRY_MODE = "entry_continuation_flag_setup_long_4h"
ENTRY_TAG = "continuation_flag_setup_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1ContinuationFlagSetupLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_flag_setup_present") & _num(dataframe, "pat_flag_direction").ge(1) & _num(dataframe, "pat_flag_indicator_score").ge(float(self.score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagSetupLong4H)
