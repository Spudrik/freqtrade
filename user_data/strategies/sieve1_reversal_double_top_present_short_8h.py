...
ENTRY_MODE = "entry_reversal_double_top_present_short_8h"
ENTRY_TAG = "reversal_double_top_present_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1ReversalDoubleTopPresentShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        level = _num(dataframe, "pat_double_top_confirmation_level", np.nan).mul(1.0 - float(self.confirmation_buffer_pct.value))
        condition = _bool(dataframe, "pat_double_top_pattern_present") & _num(dataframe, "pat_double_top_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").lt(level)
...
apply_explicit_hyperopt_surface(Sieve1ReversalDoubleTopPresentShort8H)
