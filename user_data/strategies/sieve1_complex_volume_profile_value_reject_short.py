...
ENTRY_TAG = "complex_vp_reject_short"
SIDE = "short"
...
class Sieve1ComplexVolumeProfileValueRejectShort(IStrategy):
    """
...
apply_explicit_hyperopt_surface(Sieve1ComplexVolumeProfileValueRejectShort)
