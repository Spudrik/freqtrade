...
ENTRY_MODE = "entry_continuation_flag_setup_short_8h"
ENTRY_TAG = "continuation_flag_setup_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1ContinuationFlagSetupShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagSetupShort8H)
