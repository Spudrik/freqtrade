...
ENTRY_MODE = "entry_reversal_double_bottom_confirmed_long_1d"
ENTRY_TAG = "reversal_double_bottom_confirmed_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1ReversalDoubleBottomConfirmedLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_double_bottom_pattern_confirmed") & _num(dataframe, "pat_double_bottom_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").ge(_num(dataframe, "pat_double_bottom_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1ReversalDoubleBottomConfirmedLong1D)
