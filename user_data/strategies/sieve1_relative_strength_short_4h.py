...
ENTRY_MODE = "entry_relative_strength_short_4h"
ENTRY_TAG = "relative_strength_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1RelativeStrengthShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthShort4H)
