...
class Sieve1GeometryDescendingChannelLowerBreakdownShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryDescendingChannelLowerBreakdownShort4H)
