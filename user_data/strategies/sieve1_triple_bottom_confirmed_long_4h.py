...
ENTRY_MODE = "entry_triple_bottom_confirmed_long_4h"
ENTRY_TAG = "triple_bottom_confirmed_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1TripleBottomConfirmedLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_triple_bottom_pattern_confirmed") & _num(dataframe, "pat_triple_bottom_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").ge(_num(dataframe, "pat_triple_bottom_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1TripleBottomConfirmedLong4H)
