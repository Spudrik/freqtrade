...
ENTRY_MODE = "entry_relative_strength_bear_context_short_1d"
ENTRY_TAG = "relative_strength_bear_context_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1RelativeStrengthBearContextShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthBearContextShort1D)
