...
ENTRY_MODE = "entry_tlv2_resistance_reject_short_8h"
ENTRY_TAG = "tlv2_resistance_reject_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1TLV2ResistanceRejectShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TLV2ResistanceRejectShort8H)
