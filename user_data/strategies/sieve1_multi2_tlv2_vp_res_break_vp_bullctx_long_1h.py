...
ENTRY_MODE = "entry_multi2_tlv2_vp_res_break_vp_bullctx_long_1h"
...
class Sieve1Multi2Tlv2VpResBreakVpBullctxLong1h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2VpResBreakVpBullctxLong1h)
