...
ENTRY_MODE = "entry_vp_composite_trigger_long"
ENTRY_TAG = "vp_composite_trigger_long"
SIDE = "long"
TRIGGER_COLUMN = "vp_entry_trigger_long"
CORE_BEHAVIOR = "composite VP long trigger"
...
class Sieve1VpCompositeTriggerLong(IStrategy):
    """
    Sieve1 volume-profile entry concept: composite VP long trigger.
...
apply_explicit_hyperopt_surface(Sieve1VpCompositeTriggerLong)
