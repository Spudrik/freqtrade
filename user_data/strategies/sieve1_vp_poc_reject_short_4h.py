...
ENTRY_MODE = "entry_vp_poc_reject_short_4h"
ENTRY_TAG = "vp_poc_reject_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1VPPOCRejectShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPPOCRejectShort4H)
