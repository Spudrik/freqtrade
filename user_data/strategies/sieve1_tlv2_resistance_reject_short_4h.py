...
ENTRY_MODE = "entry_tlv2_resistance_reject_short_4h"
ENTRY_TAG = "tlv2_resistance_reject_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1TLV2ResistanceRejectShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TLV2ResistanceRejectShort4H)
