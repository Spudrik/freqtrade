...
ENTRY_MODE = "entry_vp_lvn_fast_traverse_short_4h"
ENTRY_TAG = "vp_lvn_fast_traverse_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1VPLVNFastTraverseShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLVNFastTraverseShort4H)
