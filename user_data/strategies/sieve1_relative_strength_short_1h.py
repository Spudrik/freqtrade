...
ENTRY_MODE = "entry_relative_strength_short_1h"
ENTRY_TAG = "relative_strength_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1RelativeStrengthShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "rs_go_short") & _num(dataframe, "rs_score_short").ge(float(self.entry_score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthShort1H)
