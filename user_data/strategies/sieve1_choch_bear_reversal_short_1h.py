...
ENTRY_MODE = "entry_choch_bear_reversal_short_1h"
ENTRY_TAG = "choch_bear_reversal_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1ChochBearReversalShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ChochBearReversalShort1H)
