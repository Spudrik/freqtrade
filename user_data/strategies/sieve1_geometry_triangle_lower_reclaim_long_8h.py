...
ENTRY_MODE = "entry_geometry_triangle_lower_reclaim_long_8h"
ENTRY_TAG = "geometry_triangle_lower_reclaim_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1GeometryTriangleLowerReclaimLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryTriangleLowerReclaimLong8H)
