...
ENTRY_MODE = "entry_vp_value_area_reentry_short_1d"
ENTRY_TAG = "vp_value_area_reentry_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1VPValueAreaReentryShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaReentryShort1D)
