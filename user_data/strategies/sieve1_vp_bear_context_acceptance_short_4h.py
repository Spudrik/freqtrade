...
ENTRY_MODE = "entry_vp_bear_context_acceptance_short_4h"
ENTRY_TAG = "vp_bear_context_acceptance_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1VPBearContextAcceptanceShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "vp_market_context").le(-1) & _num(dataframe, "vp_score_short").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_short").ge(_num(dataframe, "vp_score_long")) & _num(dataframe, "close").lt(_num(dataframe, "vp_prior_poc", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VPBearContextAcceptanceShort4H)
