...
ENTRY_MODE = "entry_vp_value_area_breakout_long"
ENTRY_TAG = "vp_value_area_breakout_long"
SIDE = "long"
TRIGGER_COLUMN = "vp_entry_trigger_long"
CORE_BEHAVIOR = "value area breakout with pressure"
...
class Sieve1VpValueAreaBreakoutLong(IStrategy):
    """
    Sieve1 volume-profile entry concept: value area breakout with pressure.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            ...
            & _bool(dataframe, "vp_above_value_area")
            & _num(dataframe, "close").gt(_num(dataframe, "vp_prior_vah", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VpValueAreaBreakoutLong)
