...
class Sieve1Multi2Tlv2BoschochResProxRejectChochBearShort4h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2BoschochResProxRejectChochBearShort4h)
