...
ENTRY_MODE = "entry_multi2_tlv2_vp_res_prox_reject_vp_bearctx_short_8h"
ENTRY_TAG = "multi2_tlv2_vp_res_prox_reject_vp_bearctx_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1Multi2Tlv2VpResProxRejectVpBearctxShort8h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2VpResProxRejectVpBearctxShort8h)
