...
ENTRY_MODE = "entry_tlv2_support_proximity_bounce_long_8h"
ENTRY_TAG = "tlv2_support_proximity_bounce_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1TLV2SupportProximityBounceLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "tlv2_support_score_rank0").ge(float(self.score_min.value)) & _num(dataframe, "tlv2_support_distance_atr_rank0", np.nan).le(float(self.distance_atr_max.value)) & _num(dataframe, "low").le(line.mul(1.0 + float(self.line_buffer_pct.value))) & _num(dataframe, "close").gt(line) & _num(dataframe, "close").gt(_num(dataframe, "open"))
...
apply_explicit_hyperopt_surface(Sieve1TLV2SupportProximityBounceLong8H)
