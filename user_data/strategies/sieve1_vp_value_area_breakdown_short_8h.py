...
ENTRY_MODE = "entry_vp_value_area_breakdown_short_8h"
ENTRY_TAG = "vp_value_area_breakdown_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPValueAreaBreakdownShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaBreakdownShort8H)
