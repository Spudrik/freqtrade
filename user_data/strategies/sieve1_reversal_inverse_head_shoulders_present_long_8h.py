...
ENTRY_MODE = "entry_reversal_inverse_head_shoulders_present_long_8h"
ENTRY_TAG = "reversal_inverse_head_shoulders_present_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1ReversalInverseHeadShouldersPresentLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        level = _num(dataframe, "pat_inverse_head_shoulders_confirmation_level", np.nan).mul(1.0 + float(self.confirmation_buffer_pct.value))
        condition = _bool(dataframe, "pat_inverse_head_shoulders_pattern_present") & _num(dataframe, "pat_inverse_head_shoulders_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").gt(level)
...
apply_explicit_hyperopt_surface(Sieve1ReversalInverseHeadShouldersPresentLong8H)
