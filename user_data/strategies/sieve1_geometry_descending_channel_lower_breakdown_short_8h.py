...
ENTRY_MODE = "entry_geometry_descending_channel_lower_breakdown_short_8h"
ENTRY_TAG = "geometry_descending_channel_lower_breakdown_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1GeometryDescendingChannelLowerBreakdownShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        lower = _num(dataframe, "pg2_descending_channel_lower", np.nan).mul(1.0 - float(self.rail_buffer_pct.value))
        condition = _bool(dataframe, "pg2_descending_channel_pattern_present") & _num(dataframe, "pg2_descending_channel_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "pg2_descending_channel_width_atr", np.nan).le(float(self.width_atr_max.value)) & _cross_below(_num(dataframe, "close"), lower)
...
apply_explicit_hyperopt_surface(Sieve1GeometryDescendingChannelLowerBreakdownShort8H)
