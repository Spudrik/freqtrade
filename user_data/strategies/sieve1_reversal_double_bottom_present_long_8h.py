...
ENTRY_MODE = "entry_reversal_double_bottom_present_long_8h"
ENTRY_TAG = "reversal_double_bottom_present_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1ReversalDoubleBottomPresentLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ReversalDoubleBottomPresentLong8H)
