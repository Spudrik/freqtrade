...
ENTRY_MODE = "entry_reversal_double_top_confirmed_short_4h"
ENTRY_TAG = "reversal_double_top_confirmed_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1ReversalDoubleTopConfirmedShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_double_top_pattern_confirmed") & _num(dataframe, "pat_double_top_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").le(_num(dataframe, "pat_double_top_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1ReversalDoubleTopConfirmedShort4H)
