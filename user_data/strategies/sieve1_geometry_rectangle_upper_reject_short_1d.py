...
ENTRY_MODE = "entry_geometry_rectangle_upper_reject_short_1d"
ENTRY_TAG = "geometry_rectangle_upper_reject_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1GeometryRectangleUpperRejectShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pg2_rectangle_pattern_present") & _num(dataframe, "pg2_rectangle_indicator_score").ge(float(self.min_line_score.value)) & _num(dataframe, "high").ge(_num(dataframe, "pg2_rectangle_upper", np.nan)) & _num(dataframe, "close").lt(_num(dataframe, "pg2_rectangle_upper", np.nan)) & _num(dataframe, "close").lt(_num(dataframe, "open"))
...
apply_explicit_hyperopt_surface(Sieve1GeometryRectangleUpperRejectShort1D)
