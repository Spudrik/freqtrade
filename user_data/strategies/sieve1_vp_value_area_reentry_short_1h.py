...
ENTRY_MODE = "entry_vp_value_area_reentry_short_1h"
ENTRY_TAG = "vp_value_area_reentry_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPValueAreaReentryShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaReentryShort1H)
