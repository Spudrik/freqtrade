...
ENTRY_MODE = "entry_choch_bear_reversal_short_1d"
ENTRY_TAG = "choch_bear_reversal_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1ChochBearReversalShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ChochBearReversalShort1D)
