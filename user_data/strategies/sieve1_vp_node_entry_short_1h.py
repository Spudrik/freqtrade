...
ENTRY_MODE = "entry_vp_node_entry_short_1h"
ENTRY_TAG = "vp_node_entry_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPNodeEntryShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPNodeEntryShort1H)
