...
ENTRY_MODE = "entry_multi2_tlv2_boschoch_sup_reclaim_choch_bull_long_1h"
ENTRY_TAG = "multi2_tlv2_boschoch_sup_reclaim_choch_bull_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1Multi2Tlv2BoschochSupReclaimChochBullLong1h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2BoschochSupReclaimChochBullLong1h)
