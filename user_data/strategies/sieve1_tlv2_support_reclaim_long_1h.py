...
ENTRY_MODE = "entry_tlv2_support_reclaim_long_1h"
ENTRY_TAG = "tlv2_support_reclaim_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1TLV2SupportReclaimLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TLV2SupportReclaimLong1H)
