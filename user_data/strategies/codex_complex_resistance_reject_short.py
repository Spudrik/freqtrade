...
ENTRY_TAG = "codex_complex_res_reject_short"
SIDE = "short"
...
class CodexComplexResistanceRejectShort(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        swept_resistance = dataframe["high"] >= dataframe["codex_resistance_ref"] * (1.0 + buffer)
        rejected_resistance = dataframe["close"] < dataframe["codex_resistance_ref"] * (1.0 - buffer)
        condition = (
            swept_resistance
            & rejected_resistance
...
apply_explicit_hyperopt_surface(CodexComplexResistanceRejectShort)
