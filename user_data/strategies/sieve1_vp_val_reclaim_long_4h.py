...
ENTRY_MODE = "entry_vp_val_reclaim_long_4h"
ENTRY_TAG = "vp_val_reclaim_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1VPVALReclaimLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPVALReclaimLong4H)
