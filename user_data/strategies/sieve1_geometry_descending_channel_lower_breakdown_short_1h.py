...
class Sieve1GeometryDescendingChannelLowerBreakdownShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryDescendingChannelLowerBreakdownShort1H)
