...
ENTRY_MODE = "entry_multi2_vp_prior_day_high_break_vp_val_long"
ENTRY_TAG = "multi2_vp_prior_day_high_break_vp_val_long"
SIDE = "long"
TIMEFRAME = "1h"
VP_CONFIRM = "val_reclaim"
PRIOR_KIND = "day_high_breakout"

class Sieve1Multi2VpPriorDayHighBreakVpValLong(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorDayHighBreakVpValLong)
