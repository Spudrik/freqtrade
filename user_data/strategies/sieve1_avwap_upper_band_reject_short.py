...
ENTRY_MODE = "entry_avwap_upper_band_reject_short"
ENTRY_TAG = "avwap_upper_band_reject_short"
SIDE = "short"
CONCEPT = "avwap_upper_band_reject"
PERIOD_KIND = "fixed"
...
class Sieve1AvwapUpperBandRejectShort(IStrategy):
    """
    Sieve1 entry concept: avwap_upper_band_reject_short.
...
apply_explicit_hyperopt_surface(Sieve1AvwapUpperBandRejectShort)
