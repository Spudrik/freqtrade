...
ENTRY_MODE = "entry_continuation_pennant_setup_short_4h"
ENTRY_TAG = "continuation_pennant_setup_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1ContinuationPennantSetupShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_pennant_setup_present") & _num(dataframe, "pat_pennant_direction").le(-1) & _num(dataframe, "pat_pennant_indicator_score").ge(float(self.score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationPennantSetupShort4H)
