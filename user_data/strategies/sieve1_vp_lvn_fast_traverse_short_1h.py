...
ENTRY_MODE = "entry_vp_lvn_fast_traverse_short_1h"
ENTRY_TAG = "vp_lvn_fast_traverse_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1VPLVNFastTraverseShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLVNFastTraverseShort1H)
