...
ENTRY_MODE = "entry_vp_value_area_reentry_long_8h"
ENTRY_TAG = "vp_value_area_reentry_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1VPValueAreaReentryLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaReentryLong8H)
