...
ENTRY_MODE = "entry_geometry_rectangle_breakout_long_8h"
ENTRY_TAG = "geometry_rectangle_breakout_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1GeometryRectangleBreakoutLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryRectangleBreakoutLong8H)
