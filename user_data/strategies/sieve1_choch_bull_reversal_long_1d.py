...
ENTRY_MODE = "entry_choch_bull_reversal_long_1d"
ENTRY_TAG = "choch_bull_reversal_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1ChochBullReversalLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ChochBullReversalLong1D)
