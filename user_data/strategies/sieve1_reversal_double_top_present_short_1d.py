...
ENTRY_MODE = "entry_reversal_double_top_present_short_1d"
ENTRY_TAG = "reversal_double_top_present_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1ReversalDoubleTopPresentShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ReversalDoubleTopPresentShort1D)
