...
ENTRY_MODE = "entry_geometry_wedge_breakout_long_1d"
ENTRY_TAG = "geometry_wedge_breakout_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1GeometryWedgeBreakoutLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pg2_wedge_pattern_present") & _bool(dataframe, "pg2_wedge_squeeze_active") & _num(dataframe, "pg2_wedge_indicator_score").ge(float(self.min_line_score.value)) & _num(dataframe, "pg2_wedge_direction").ge(0) & _num(dataframe, "close").gt(_num(dataframe, "pg2_wedge_upper", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1GeometryWedgeBreakoutLong1D)
