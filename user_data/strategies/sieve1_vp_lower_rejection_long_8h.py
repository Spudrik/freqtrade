...
ENTRY_MODE = "entry_vp_lower_rejection_long_8h"
ENTRY_TAG = "vp_lower_rejection_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1VPLowerRejectionLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLowerRejectionLong8H)
