...
ENTRY_MODE = "entry_continuation_flag_confirmed_short_1h"
ENTRY_TAG = "continuation_flag_confirmed_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1ContinuationFlagConfirmedShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagConfirmedShort1H)
