...
ENTRY_MODE = "entry_relative_strength_persistent_long_8h"
ENTRY_TAG = "relative_strength_persistent_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1RelativeStrengthPersistentLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "rs_entry_persistent_strength_long") & _num(dataframe, "rs_score_long").ge(float(self.entry_score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthPersistentLong8H)
