...
ENTRY_MODE = "entry_vp_bull_context_acceptance_long_4h"
ENTRY_TAG = "vp_bull_context_acceptance_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1VPBullContextAcceptanceLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "vp_market_context").ge(1) & _num(dataframe, "vp_score_long").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_long").ge(_num(dataframe, "vp_score_short")) & _num(dataframe, "close").gt(_num(dataframe, "vp_prior_poc", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VPBullContextAcceptanceLong4H)
