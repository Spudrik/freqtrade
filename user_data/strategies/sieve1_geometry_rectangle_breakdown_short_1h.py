...
ENTRY_MODE = "entry_geometry_rectangle_breakdown_short_1h"
...
class Sieve1GeometryRectangleBreakdownShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryRectangleBreakdownShort1H)
