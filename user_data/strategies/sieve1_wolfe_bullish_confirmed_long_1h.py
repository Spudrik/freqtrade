...
ENTRY_MODE = "entry_wolfe_bullish_confirmed_long_1h"
ENTRY_TAG = "wolfe_bullish_confirmed_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1WolfeBullishConfirmedLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1WolfeBullishConfirmedLong1H)
