...
ENTRY_MODE = "entry_vp_lvn_fast_traverse_short_1d"
ENTRY_TAG = "vp_lvn_fast_traverse_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1VPLVNFastTraverseShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLVNFastTraverseShort1D)
