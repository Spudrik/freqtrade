...
ENTRY_MODE = "entry_vp_upper_rejection_short_1d"
ENTRY_TAG = "vp_upper_rejection_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1VPUpperRejectionShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPUpperRejectionShort1D)
