...
ENTRY_MODE = "entry_tlv2_resistance_proximity_reject_short_1h"
ENTRY_TAG = "tlv2_resistance_proximity_reject_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1TLV2ResistanceProximityRejectShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TLV2ResistanceProximityRejectShort1H)
