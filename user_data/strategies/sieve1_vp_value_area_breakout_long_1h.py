...
ENTRY_MODE = "entry_vp_value_area_breakout_long_1h"
ENTRY_TAG = "vp_value_area_breakout_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1VPValueAreaBreakoutLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPValueAreaBreakoutLong1H)
