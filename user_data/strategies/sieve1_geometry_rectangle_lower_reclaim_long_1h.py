...
ENTRY_MODE = "entry_geometry_rectangle_lower_reclaim_long_1h"
ENTRY_TAG = "geometry_rectangle_lower_reclaim_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1GeometryRectangleLowerReclaimLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pg2_rectangle_pattern_present") & _num(dataframe, "pg2_rectangle_indicator_score").ge(float(self.min_line_score.value)) & _num(dataframe, "low").le(_num(dataframe, "pg2_rectangle_lower", np.nan)) & _num(dataframe, "close").gt(_num(dataframe, "pg2_rectangle_lower", np.nan)) & _num(dataframe, "close").gt(_num(dataframe, "open"))
...
apply_explicit_hyperopt_surface(Sieve1GeometryRectangleLowerReclaimLong1H)
