...
ENTRY_MODE = "entry_tlv2_falling_resistance_ride_short_1h"
ENTRY_TAG = "tlv2_falling_resistance_ride_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1TLV2FallingResistanceRideShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TLV2FallingResistanceRideShort1H)
