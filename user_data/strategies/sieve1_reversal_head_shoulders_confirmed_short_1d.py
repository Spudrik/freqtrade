...
ENTRY_MODE = "entry_reversal_head_shoulders_confirmed_short_1d"
ENTRY_TAG = "reversal_head_shoulders_confirmed_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1ReversalHeadShouldersConfirmedShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_head_shoulders_pattern_confirmed") & _num(dataframe, "pat_head_shoulders_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").le(_num(dataframe, "pat_head_shoulders_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1ReversalHeadShouldersConfirmedShort1D)
