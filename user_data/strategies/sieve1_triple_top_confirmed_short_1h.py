...
ENTRY_MODE = "entry_triple_top_confirmed_short_1h"
ENTRY_TAG = "triple_top_confirmed_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1TripleTopConfirmedShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TripleTopConfirmedShort1H)
