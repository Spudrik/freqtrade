...
ENTRY_MODE = "entry_geometry_compression_breakout_long_1h"
ENTRY_TAG = "geometry_compression_breakout_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1GeometryCompressionBreakoutLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pg2_compression_pattern_present") & _bool(dataframe, "pg2_compression_squeeze_active") & _num(dataframe, "pg2_compression_indicator_score").ge(float(self.min_line_score.value)) & _num(dataframe, "pg2_compression_direction").ge(0) & _num(dataframe, "close").gt(_num(dataframe, "pg2_compression_upper", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1GeometryCompressionBreakoutLong1H)
