...
ENTRY_MODE = "entry_wolfe_bearish_present_short_8h"
ENTRY_TAG = "wolfe_bearish_present_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1WolfeBearishPresentShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1WolfeBearishPresentShort8H)
