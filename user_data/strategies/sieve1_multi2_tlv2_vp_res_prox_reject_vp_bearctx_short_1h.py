...
ENTRY_MODE = "entry_multi2_tlv2_vp_res_prox_reject_vp_bearctx_short_1h"
ENTRY_TAG = "multi2_tlv2_vp_res_prox_reject_vp_bearctx_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1Multi2Tlv2VpResProxRejectVpBearctxShort1h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2VpResProxRejectVpBearctxShort1h)
