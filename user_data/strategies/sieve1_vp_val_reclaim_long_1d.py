...
ENTRY_MODE = "entry_vp_val_reclaim_long_1d"
ENTRY_TAG = "vp_val_reclaim_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1VPVALReclaimLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "low").lt(val) & _num(dataframe, "close").gt(val) & _num(dataframe, "vp_score_long").ge(float(self.score_min.value)) & _num(dataframe, "vp_score_long").ge(_num(dataframe, "vp_score_short"))
...
apply_explicit_hyperopt_surface(Sieve1VPVALReclaimLong1D)
