...
ENTRY_MODE = "entry_geometry_rectangle_breakout_long_1h"
ENTRY_TAG = "geometry_rectangle_breakout_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1GeometryRectangleBreakoutLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryRectangleBreakoutLong1H)
