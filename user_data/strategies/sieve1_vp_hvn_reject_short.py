...
ENTRY_MODE = "entry_vp_hvn_reject_short"
ENTRY_TAG = "vp_hvn_reject_short"
SIDE = "short"
TRIGGER_COLUMN = "vp_node_entry_short"
CORE_BEHAVIOR = "HVN rejection from above"
...
class Sieve1VpHvnRejectShort(IStrategy):
    """
    Sieve1 volume-profile entry concept: HVN rejection from above.
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            ...
            & _num(dataframe, "close").lt(_num(dataframe, "vp_hvn_above", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1VpHvnRejectShort)
