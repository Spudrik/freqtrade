...
ENTRY_MODE = "entry_wolfe_bearish_confirmed_short_1h"
ENTRY_TAG = "wolfe_bearish_confirmed_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1WolfeBearishConfirmedShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1WolfeBearishConfirmedShort1H)
