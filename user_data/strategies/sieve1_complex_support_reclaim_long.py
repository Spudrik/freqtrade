...
ENTRY_TAG = "complex_sup_reclaim_long"
SIDE = "long"
...
class Sieve1ComplexSupportReclaimLong(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        swept_support = dataframe["low"] <= dataframe["support_ref"] * (1.0 - buffer)
        reclaimed_support = dataframe["close"] > dataframe["support_ref"] * (1.0 + buffer)
        condition = (
            swept_support
            & reclaimed_support
...
apply_explicit_hyperopt_surface(Sieve1ComplexSupportReclaimLong)
