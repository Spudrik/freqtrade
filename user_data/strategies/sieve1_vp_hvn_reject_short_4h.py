...
ENTRY_MODE = "entry_vp_hvn_reject_short_4h"
ENTRY_TAG = "vp_hvn_reject_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1VPHVNRejectShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPHVNRejectShort4H)
