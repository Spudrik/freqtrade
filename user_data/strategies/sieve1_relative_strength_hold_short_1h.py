...
ENTRY_MODE = "entry_relative_strength_hold_short_1h"
ENTRY_TAG = "relative_strength_hold_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1RelativeStrengthHoldShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthHoldShort1H)
