...
ENTRY_MODE = "entry_continuation_flag_setup_short_1d"
ENTRY_TAG = "continuation_flag_setup_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1ContinuationFlagSetupShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagSetupShort1D)
