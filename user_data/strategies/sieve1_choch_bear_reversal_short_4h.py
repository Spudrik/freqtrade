...
ENTRY_MODE = "entry_choch_bear_reversal_short_4h"
ENTRY_TAG = "choch_bear_reversal_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1ChochBearReversalShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ChochBearReversalShort4H)
