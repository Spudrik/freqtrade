...
ENTRY_MODE = "entry_vp_bull_context_acceptance_long_1d"
ENTRY_TAG = "vp_bull_context_acceptance_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1VPBullContextAcceptanceLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPBullContextAcceptanceLong1D)
