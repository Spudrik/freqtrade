...
ENTRY_MODE = "entry_geometry_ascending_channel_upper_reject_short_1h"
ENTRY_TAG = "geometry_ascending_channel_upper_reject_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1GeometryAscendingChannelUpperRejectShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryAscendingChannelUpperRejectShort1H)
