...
ENTRY_MODE = "entry_triple_top_present_short_1h"
ENTRY_TAG = "triple_top_present_short_1h"
SIDE = "short"
TIMEFRAME = "1h"
...
class Sieve1TripleTopPresentShort1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TripleTopPresentShort1H)
