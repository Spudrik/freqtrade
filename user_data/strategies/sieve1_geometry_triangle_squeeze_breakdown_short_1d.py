...
ENTRY_MODE = "entry_geometry_triangle_squeeze_breakdown_short_1d"
ENTRY_TAG = "geometry_triangle_squeeze_breakdown_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1GeometryTriangleSqueezeBreakdownShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pg2_triangle_pattern_present") & _bool(dataframe, "pg2_triangle_squeeze_active") & _num(dataframe, "pg2_triangle_indicator_score").ge(float(self.min_line_score.value)) & _num(dataframe, "pg2_triangle_direction").le(0) & _num(dataframe, "close").lt(_num(dataframe, "pg2_triangle_lower", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1GeometryTriangleSqueezeBreakdownShort1D)
