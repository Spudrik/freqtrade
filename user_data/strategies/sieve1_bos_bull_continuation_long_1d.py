...
ENTRY_MODE = "entry_bos_bull_continuation_long_1d"
ENTRY_TAG = "bos_bull_continuation_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1BOSBullContinuationLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1BOSBullContinuationLong1D)
