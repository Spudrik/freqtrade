...
ENTRY_MODE = "entry_vp_lower_rejection_long_1h"
ENTRY_TAG = "vp_lower_rejection_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1VPLowerRejectionLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPLowerRejectionLong1H)
