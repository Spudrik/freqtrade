...
ENTRY_MODE = "entry_continuation_flag_present_long_1d"
ENTRY_TAG = "continuation_flag_present_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1ContinuationFlagPresentLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_flag_pattern_present") & _num(dataframe, "pat_flag_direction").ge(1) & _num(dataframe, "pat_flag_indicator_score").ge(float(self.score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagPresentLong1D)
