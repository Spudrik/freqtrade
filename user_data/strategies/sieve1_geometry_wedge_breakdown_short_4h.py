...
ENTRY_MODE = "entry_geometry_wedge_breakdown_short_4h"
...
class Sieve1GeometryWedgeBreakdownShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryWedgeBreakdownShort4H)
