...
ENTRY_MODE = "entry_relative_strength_bull_context_long_1h"
ENTRY_TAG = "relative_strength_bull_context_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1RelativeStrengthBullContextLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "rs_market_context").ge(int(self.context_gate.value)) & _num(dataframe, "rs_score_long").gt(_num(dataframe, "rs_score_short"))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthBullContextLong1H)
