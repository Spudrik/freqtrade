...
ENTRY_MODE = "entry_continuation_flag_confirmed_long_4h"
ENTRY_TAG = "continuation_flag_confirmed_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1ContinuationFlagConfirmedLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_flag_pattern_confirmed") & _num(dataframe, "pat_flag_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").ge(_num(dataframe, "pat_flag_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagConfirmedLong4H)
