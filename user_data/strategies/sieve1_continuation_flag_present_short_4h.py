...
ENTRY_MODE = "entry_continuation_flag_present_short_4h"
ENTRY_TAG = "continuation_flag_present_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1ContinuationFlagPresentShort4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagPresentShort4H)
