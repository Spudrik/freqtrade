...
ENTRY_MODE = "entry_tlv2_rising_support_ride_long_8h"
ENTRY_TAG = "tlv2_rising_support_ride_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1TLV2RisingSupportRideLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _num(dataframe, "tlv2_support_score_rank0").ge(float(self.score_min.value)) & _num(dataframe, "tlv2_support_distance_atr_rank0", np.nan).le(float(self.distance_atr_max.value)) & line.pct_change(fill_method=None).gt(float(self.line_slope_min_pct.value)) & _num(dataframe, "close").gt(line)
...
apply_explicit_hyperopt_surface(Sieve1TLV2RisingSupportRideLong8H)
