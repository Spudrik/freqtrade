...
ENTRY_MODE = "entry_relative_strength_hold_short_1d"
ENTRY_TAG = "relative_strength_hold_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1RelativeStrengthHoldShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "rs_hold_short") & _num(dataframe, "rs_score_short").ge(float(self.entry_score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1RelativeStrengthHoldShort1D)
