...
ENTRY_MODE = "entry_geometry_wedge_lower_reclaim_long_4h"
ENTRY_TAG = "geometry_wedge_lower_reclaim_long_4h"
SIDE = "long"
TIMEFRAME = "4h"
...
class Sieve1GeometryWedgeLowerReclaimLong4H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryWedgeLowerReclaimLong4H)
