...
ENTRY_MODE = "entry_vp_entry_trigger_short_1d"
ENTRY_TAG = "vp_entry_trigger_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1VPEntryTriggerShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPEntryTriggerShort1D)
