...
ENTRY_MODE = "entry_tlv2_resistance_breakout_long_8h"
ENTRY_TAG = "tlv2_resistance_breakout_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1TLV2ResistanceBreakoutLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        line = _num(dataframe, "tlv2_resistance_line_rank0", np.nan).mul(1.0 + float(self.line_buffer_pct.value))
        condition = _num(dataframe, "tlv2_resistance_score_rank0").ge(float(self.score_min.value)) & _cross_above(_num(dataframe, "close"), line)
...
apply_explicit_hyperopt_surface(Sieve1TLV2ResistanceBreakoutLong8H)
