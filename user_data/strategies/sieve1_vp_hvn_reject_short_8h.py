...
ENTRY_MODE = "entry_vp_hvn_reject_short_8h"
ENTRY_TAG = "vp_hvn_reject_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPHVNRejectShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPHVNRejectShort8H)
