...
ENTRY_MODE = "entry_multi2_vp_prior_week_high_break_vp_val_long"
ENTRY_TAG = "multi2_vp_prior_week_high_break_vp_val_long"
SIDE = "long"
TIMEFRAME = "1h"
VP_CONFIRM = "val_reclaim"
PRIOR_KIND = "week_high_breakout"

class Sieve1Multi2VpPriorWeekHighBreakVpValLong(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorWeekHighBreakVpValLong)
