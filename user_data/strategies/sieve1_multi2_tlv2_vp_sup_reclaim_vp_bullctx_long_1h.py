...
ENTRY_MODE = "entry_multi2_tlv2_vp_sup_reclaim_vp_bullctx_long_1h"
ENTRY_TAG = "multi2_tlv2_vp_sup_reclaim_vp_bullctx_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1Multi2Tlv2VpSupReclaimVpBullctxLong1h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2VpSupReclaimVpBullctxLong1h)
