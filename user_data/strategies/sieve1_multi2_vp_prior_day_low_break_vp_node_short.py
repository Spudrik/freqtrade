...
ENTRY_MODE = "entry_multi2_vp_prior_day_low_break_vp_node_short"
ENTRY_TAG = "multi2_vp_prior_day_low_break_vp_node_short"
SIDE = "short"
TIMEFRAME = "1h"
VP_CONFIRM = "node_entry"
PRIOR_KIND = "day_low_breakdown"

class Sieve1Multi2VpPriorDayLowBreakVpNodeShort(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorDayLowBreakVpNodeShort)
