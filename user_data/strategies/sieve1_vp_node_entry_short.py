...
ENTRY_MODE = "entry_vp_node_entry_short"
ENTRY_TAG = "vp_node_entry_short"
SIDE = "short"
TRIGGER_COLUMN = "vp_node_entry_short"
CORE_BEHAVIOR = "VP node-only short trigger"
...
class Sieve1VpNodeEntryShort(IStrategy):
    """
    Sieve1 volume-profile entry concept: VP node-only short trigger.
...
apply_explicit_hyperopt_surface(Sieve1VpNodeEntryShort)
