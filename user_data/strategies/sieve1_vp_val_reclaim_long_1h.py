...
ENTRY_MODE = "entry_vp_val_reclaim_long_1h"
ENTRY_TAG = "vp_val_reclaim_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1VPVALReclaimLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPVALReclaimLong1H)
