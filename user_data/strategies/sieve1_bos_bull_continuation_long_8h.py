...
ENTRY_MODE = "entry_bos_bull_continuation_long_8h"
ENTRY_TAG = "bos_bull_continuation_long_8h"
SIDE = "long"
TIMEFRAME = "8h"
...
class Sieve1BOSBullContinuationLong8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1BOSBullContinuationLong8H)
