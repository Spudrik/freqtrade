...
ENTRY_TAG = "complex_res_break_long"
SIDE = "long"
...
class Sieve1ComplexResistanceBreakoutLong(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = (
            (dataframe["close"] > dataframe["resistance_ref"] * (1.0 + buffer))
...
apply_explicit_hyperopt_surface(Sieve1ComplexResistanceBreakoutLong)
