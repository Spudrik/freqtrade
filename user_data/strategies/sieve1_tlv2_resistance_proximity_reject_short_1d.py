...
ENTRY_MODE = "entry_tlv2_resistance_proximity_reject_short_1d"
ENTRY_TAG = "tlv2_resistance_proximity_reject_short_1d"
SIDE = "short"
TIMEFRAME = "1d"
...
class Sieve1TLV2ResistanceProximityRejectShort1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1TLV2ResistanceProximityRejectShort1D)
