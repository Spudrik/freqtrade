...
ENTRY_MODE = "entry_geometry_triangle_squeeze_breakout_long_1h"
...
class Sieve1GeometryTriangleSqueezeBreakoutLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryTriangleSqueezeBreakoutLong1H)
