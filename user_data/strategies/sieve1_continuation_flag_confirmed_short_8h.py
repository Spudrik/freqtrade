...
ENTRY_MODE = "entry_continuation_flag_confirmed_short_8h"
ENTRY_TAG = "continuation_flag_confirmed_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1ContinuationFlagConfirmedShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_flag_pattern_confirmed") & _num(dataframe, "pat_flag_indicator_score").ge(float(self.score_min.value)) & _num(dataframe, "close").le(_num(dataframe, "pat_flag_confirmation_level", np.nan))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagConfirmedShort8H)
