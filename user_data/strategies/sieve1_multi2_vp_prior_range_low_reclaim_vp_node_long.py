...
ENTRY_MODE = "entry_multi2_vp_prior_range_low_reclaim_vp_node_long"
ENTRY_TAG = "multi2_vp_prior_range_low_reclaim_vp_node_long"
SIDE = "long"
TIMEFRAME = "1h"
VP_CONFIRM = "node_entry"
PRIOR_KIND = "range_low_reclaim"

class Sieve1Multi2VpPriorRangeLowReclaimVpNodeLong(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2VpPriorRangeLowReclaimVpNodeLong)
