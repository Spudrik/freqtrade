...
ENTRY_MODE = "entry_continuation_pennant_setup_long_1h"
ENTRY_TAG = "continuation_pennant_setup_long_1h"
SIDE = "long"
TIMEFRAME = "1h"
...
class Sieve1ContinuationPennantSetupLong1H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        condition = _bool(dataframe, "pat_pennant_setup_present") & _num(dataframe, "pat_pennant_direction").ge(1) & _num(dataframe, "pat_pennant_indicator_score").ge(float(self.score_min.value))
...
apply_explicit_hyperopt_surface(Sieve1ContinuationPennantSetupLong1H)
