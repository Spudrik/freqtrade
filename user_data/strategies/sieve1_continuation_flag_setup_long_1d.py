...
ENTRY_MODE = "entry_continuation_flag_setup_long_1d"
ENTRY_TAG = "continuation_flag_setup_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1ContinuationFlagSetupLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1ContinuationFlagSetupLong1D)
