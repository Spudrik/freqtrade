...
ENTRY_MODE = "entry_multi2_tlv2_vp_res_prox_reject_vp_bearctx_short_4h"
ENTRY_TAG = "multi2_tlv2_vp_res_prox_reject_vp_bearctx_short_4h"
SIDE = "short"
TIMEFRAME = "4h"
...
class Sieve1Multi2Tlv2VpResProxRejectVpBearctxShort4h(IStrategy):
...
apply_explicit_hyperopt_surface(Sieve1Multi2Tlv2VpResProxRejectVpBearctxShort4h)
