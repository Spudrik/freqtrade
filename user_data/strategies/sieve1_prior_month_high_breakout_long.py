...
class Sieve1PriorMonthHighBreakoutLong(IStrategy):
    """
    Sieve1 entry concept: prior_month_high_breakout_long.
...
apply_explicit_hyperopt_surface(Sieve1PriorMonthHighBreakoutLong)
