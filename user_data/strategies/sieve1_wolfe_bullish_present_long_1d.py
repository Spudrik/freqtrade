...
ENTRY_MODE = "entry_wolfe_bullish_present_long_1d"
ENTRY_TAG = "wolfe_bullish_present_long_1d"
SIDE = "long"
TIMEFRAME = "1d"
...
class Sieve1WolfeBullishPresentLong1D(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1WolfeBullishPresentLong1D)
