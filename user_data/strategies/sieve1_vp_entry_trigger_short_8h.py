...
ENTRY_MODE = "entry_vp_entry_trigger_short_8h"
ENTRY_TAG = "vp_entry_trigger_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1VPEntryTriggerShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1VPEntryTriggerShort8H)
