...
ENTRY_MODE = "entry_geometry_ascending_channel_upper_reject_short_8h"
ENTRY_TAG = "geometry_ascending_channel_upper_reject_short_8h"
SIDE = "short"
TIMEFRAME = "8h"
...
class Sieve1GeometryAscendingChannelUpperRejectShort8H(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = TIMEFRAME
...
apply_explicit_hyperopt_surface(Sieve1GeometryAscendingChannelUpperRejectShort8H)
