...
from freqtrade.data.metrics import calculate_underwater, calculate_max_drawdown

# Adjustable weights for each factor
profit_weight_low = 6.0    # Higher value makes profit more important
profit_weight = 260.0    # Higher value makes profit more important
trade_weight_nonideal_results = 65.0      # Higher value makes more trades better
trade_weight_best_results = 80.0      # Higher value makes more trades better
winrate_weight_high = 320.0    # Higher value makes better win rates more rewarding
winrate_weight_low = 100.0    # Higher value makes better win rates more rewarding
drawdown_weight = 20
...
class CustomHyper(IHyperOptLoss):
    ...
    def hyperopt_loss_function(results: DataFrame, trade_count: int,
        ...
        winrate = kwargs['backtest_stats']['winrate']
        ...
        if abs_profit <= 0:
            ...
            loss = weighted_daily_profit / (1 + winrate) / average_trades_per_day
