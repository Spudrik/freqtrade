...
def pairlists_evaluate(
    ...
    config_loc["download_orderbook"] = payload.download_orderbook
    config_loc["orderbook_depth"] = payload.orderbook_depth
    config_loc["orderbook_category"] = payload.orderbook_category
